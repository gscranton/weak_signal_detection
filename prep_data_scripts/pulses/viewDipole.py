...
data1 = np.array(df['7.54 kA-m2, 0 m HCPA'])
data2 = np.array(df['113.1 kA-m2, 300 m HCPA'])
...
cs = CubicSpline(t,data1_mod2)
tfine = np.arange(0,144.248,0.004)
data1_mod3 = cs(tfine)
...
plt.plot(tfine,data1_mod3)
plt.legend(['Original data','Savgol filter','Savgol filter + CS interp'])
